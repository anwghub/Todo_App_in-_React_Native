...
const index = () => {
  ...
  const fetchTaskData = async () => {
    try {
      const response = await axios.get("http://192.168.1.100:3000/todos/count");
    ...
    <View style={{ padding: 10, flex: 1, backgroundColor: "white" }}>
      <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
        <Image
          ...
          source={{
            uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeAhTBdJJ2aMJSXI5O5eEIWBTxowWRNq1eYQ&s",
          }}
        />
        <View>
